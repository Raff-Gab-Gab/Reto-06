...
# Floor Manager
Para poder manipular el suelo, se crearon dos scripts: el FloorManager y Floor. Este último, se colocó en cada una de las secciones del suelo como componente y posee dos funciones, Start y OnDestroy. En Start, se añaden los game objects de clase Floor a una lista en FloorManager, mientras que OnDestroy se remueven de ella cuando fueron destruidos.
